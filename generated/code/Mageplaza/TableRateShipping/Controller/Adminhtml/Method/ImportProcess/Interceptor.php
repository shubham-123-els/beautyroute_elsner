<?php
namespace Mageplaza\TableRateShipping\Controller\Adminhtml\Method\ImportProcess;

/**
 * Interceptor class for @see \Mageplaza\TableRateShipping\Controller\Adminhtml\Method\ImportProcess
 */
class Interceptor extends \Mageplaza\TableRateShipping\Controller\Adminhtml\Method\ImportProcess implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $resultPageFactory, $registry, $filter, $helper, $media, $methodFactory, $methodResource, $logger, $resultRawFactory, $layoutFactory, $rateFactory, $rateResource);
    }
