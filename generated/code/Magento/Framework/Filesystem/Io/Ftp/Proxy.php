<?php
namespace Magento\Framework\Filesystem\Io\Ftp;

/**
 * Proxy class for @see \Magento\Framework\Filesystem\Io\Ftp
 */
class Proxy extends \Magento\Framework\Filesystem\Io\Ftp implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Framework\\Filesystem\\Io\\Ftp', $shared = true)
    {
     ...
     *
     * @return \Magento\Framework\Filesystem\Io\Ftp
     */
    ...
    {
        return $this->_getSubject()->read($filename, $dest);
    }
    ...
    {
        return $this->_getSubject()->write($filename, $src, $mode);
    }
    ...
    {
        return $this->_getSubject()->mv($src, $dest);
    }
