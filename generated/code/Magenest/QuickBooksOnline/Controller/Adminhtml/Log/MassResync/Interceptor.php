<?php
namespace Magenest\QuickBooksOnline\Controller\Adminhtml\Log\MassResync;

/**
 * Interceptor class for @see \Magenest\QuickBooksOnline\Controller\Adminhtml\Log\MassResync
 */
class Interceptor extends \Magenest\QuickBooksOnline\Controller\Adminhtml\Log\MassResync implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $resultPageFactory, $collectionFactory, $config, $customer, $item, $order, $invoice, $creditmemo, $paymentMethods, $taxCode, $messageManager, $scopeConfig, $taxFactory, $orderFactory, $orderResource, $filter);
    }
