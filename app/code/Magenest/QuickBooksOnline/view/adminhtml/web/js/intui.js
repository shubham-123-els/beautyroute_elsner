define([
    ...
    intuit.ipp.anywhere = {
        ...
        windowLoad: function () {
                var jsSrc = "https://appcenter.intuit.com/Content/IA/intuit.ipp.anywhere.js";
        ...
        init: function (srcFile) {
            ...
            (function ($) {
                ...
                function Scrollbar(root, options) {
                    var oSelf = this;
                    var oWrapper = root;
                    var oViewport = {obj: $('.intuitPlatformAppMenuDropdownAppsListScrollViewport', root)};
                    var oContent = {obj: $('.intuitPlatformAppMenuDropdownAppsListScrollOverview', root)};
                    var oScrollbar = {obj: $('.intuitPlatformAppMenuDropdownAppsListScrollbar', root)};
                    var oTrack = {obj: $('.intuitPlatformAppMenuDropdownAppsListScrollTrack', oScrollbar.obj)};
                    var oThumb = {obj: $('.intuitPlatformAppMenuDropdownAppsListScrollThumb', oScrollbar.obj)};
                    var sAxis = options.axis == 'x', sDirection = sAxis ? 'left' : 'top',
                    ...
                    this.update = function (sScroll) {
                        ...
                        oScrollbar.obj.toggleClass('intuitPlatformAppMenuDropdownAppsListScrollDisable', oContent.ratio >= 1);
    ...
    intuit.ipp.anywhere.view = {
        ...
        login: {
            render: function (elem) {
                ...
                type = type.replace(/\b[a-z]/g, function () {
...
// function that starts it all. timeout is 0
    intuit.startConnection = function () {
