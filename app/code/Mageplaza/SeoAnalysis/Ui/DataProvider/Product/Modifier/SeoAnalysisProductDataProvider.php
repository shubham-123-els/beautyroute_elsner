...
class SeoAnalysisProductDataProvider extends AbstractModifier
{
    ...
    public function setFieldSearchEngineOptimization(&$meta, $field, $component, $template)
    {
        if (isset($meta['search-engine-optimization']['children']['container_' . $field])) {
            $meta['search-engine-optimization']['children']['container_'
            . $field]['children'][$field]['arguments']['data']['config']['elementTmpl'] = $template;
            $meta['search-engine-optimization']['children']['container_'
            . $field]['children'][$field]['arguments']['data']['config']['component']   = $component;
        }
    ...
    public function disableFields(&$meta)
    {
        ...
        foreach ($fields as $field) {
            if (isset($meta['search-engine-optimization']['children']['container_' . $field])) {
                $meta['search-engine-optimization']['children']['container_'
                . $field]['children'][$field]['arguments']['data']['config']['visible'] = 0;
            }
        }
    }
    ...
    public function sortFields(&$meta)
    {
        ...
        foreach ($fields as $field) {
            if (isset($meta['search-engine-optimization']['children']['container_' . $field['attribute']])) {
                $meta['search-engine-optimization']['children']['container_'
                . $field['attribute']]['arguments']['data']['config']['sortOrder'] = $field['sort_order'];
                $meta['search-engine-optimization']['children']['container_' . $field['attribute']]['children']
                [$field['attribute']]['arguments']['data']['config']['sortOrder']  = $field['sort_order'];
            }
        }
