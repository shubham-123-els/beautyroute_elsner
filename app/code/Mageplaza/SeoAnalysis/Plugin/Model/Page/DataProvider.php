...
namespace Mageplaza\SeoAnalysis\Plugin\Model\Page;
 ...
 * Class DataProvider
 *
 * @package Mageplaza\SeoAnalysis\Plugin\Model\Page
 */
class DataProvider
{
    /**
    ...
    /**
     * @param CmsDataProvider $subject
     * @param $data
     *
     * @return mixed
     */
    public function afterGetData(CmsDataProvider $subject, $data)
    {
