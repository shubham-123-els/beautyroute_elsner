...
use Mageplaza\Redirects\Block\Adminhtml\Redirect\Render\Button;
...
class Form extends Generic
{
    ...
    {
        if ($this->_backendSession->getSeoRedirectDataDeleted()
            && is_array($this->_backendSession->getSeoRedirectDataDeleted())) {
            ...
            foreach ($this->_backendSession->getSeoRedirectDataDeleted() as $key => $value) {
                ...
                $fieldset->addType('redirect', Button::class);
