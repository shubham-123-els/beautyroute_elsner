    ...
    protected function _prepareForm()
    {
        $this->setChild(
            ...
            $this->getLayout()->createBlock(Dependence::class)
                ->addFieldMap('rule_type', 'rule[type]')
                ->addFieldMap('rule_auto_add_by', 'rule[auto_add_by]')
                ->addFieldDependence('rule[auto_add_by]', 'rule[type]', 'automatic')
        );
