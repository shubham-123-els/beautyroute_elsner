...
class Actions extends AbstractTab
{
    ...
    protected function _prepareForm()
    {
        ...
        $actionsFieldset->addField('auto_add_by', 'select', [
            'name'   => 'auto_add_by',
            'label'  => __('Automatically Add Free Gift to Cart by'),
            'title'  => __('Automatically Add Free Gift to Cart by'),
            'values' => $this->addAutoBy->toOptionArray(),
            'note'   => __('Choose how to automatically get free gift products when buying products.')
        ]);
