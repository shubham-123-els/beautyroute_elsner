...
class Data extends AbstractData
{
     ...
     * @return mixed
     */
    public function getEnabledItemRuleReport($storeId = null)
    {
        return $this->getConfigGeneral('enabled_item_rule_report', $storeId);
    }
     ...
     * @return mixed
     */
    public function getEnabledCartRuleReport($storeId = null)
    {
        return $this->getConfigGeneral('enabled_cart_rule_report', $storeId);
    }
     ...
     * @return mixed
     */
    public function getPrefixItemName($storeId = null)
    {
        return $this->getConfigGeneral('prefix_item_name', $storeId);
    }
     ...
     */
    public function getBannersByRuleId($ruleId)
    {
        return $this->bannerFactory->create()->getCollection()->addFieldToFilter('rule_id', $ruleId)
     ...
     * @return mixed
     */
    public function isNoFgProductSpecialPrice()
    {
        return $this->getConfigGeneral('fg_product_special_price', $this->getStoreId());
    }

    /**
     * @return mixed
     */
    public function isNoFgConfigurableProductSpecialPrice()
    {
        return $this->getConfigGeneral('fg_configurable_product_special_price', $this->getStoreId());
    }
}
