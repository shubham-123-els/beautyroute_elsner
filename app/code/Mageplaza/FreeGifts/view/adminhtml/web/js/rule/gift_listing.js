    ...
    $.widget('mpfreegifts.giftListing', {
        ...
        _create: function () {
            ...
            $(helper.gridEditItem.discount_type).on('change', function () {
                var type = $(this).parents('#mpfreegifts-gift-item-edit-form').find('#mpfreegifts-edit-product_type').val();

                helper.toggleDiscountType(this.value, type);
            });
        ...
        openEditModal: function (item) {
            ...
            helper.toggleDiscountType($(item).data('discount_type'), $(item).data('product_type'));
