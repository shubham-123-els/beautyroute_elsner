...
class Data extends AbstractData
{
     ...
     * @return array
     */
    public function getConfigChecklist($storeId)
    {
        $urlSearchEngines = $this->_urlBuilder->getUrl('adminhtml/system_config/edit/section/design') .
            'store/' . $storeId . '#google_analytics-head';
