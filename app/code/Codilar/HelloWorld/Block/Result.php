...
class Result extends Template
{
    ...
    public function getSearchQueryText()
    {
        ...
        if ($storeName=="English") {
            return __("Search results for: '%1'", $this->getRemovezero());
        } else {
            return __("Résultats de recherche pour: '%1'", $this->getRemovezero());
        }
    }

    public function getRemovezero()
    {

         $text  = $this->catalogSearchData->getEscapedQueryText();
         return ($text == '0') ? 'All':$text;
    }
