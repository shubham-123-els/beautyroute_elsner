...
return [
    'modules' => [
        ...
        'Elsner_Email' => 1,
        'Elsnertech_About' => 1,
        'Elsnertech_Brandcustomization' => 1,
        'Elsnertech_CustomCategoryBanner' => 1,
        'Elsnertech_Customization' => 1,
        'Mconnect_Iconlib' => 1,
        'WeltPixel_Backend' => 1,
        'Elsnertech_ProductCustomization' => 1,
        'Elsnertech_Professional' => 1,
        'Elsnertech_SpeedBooster' => 1,
        'Elsnertech_StorePrice' => 1,
        'Facebook_BusinessExtension' => 1,
        'FishPig_WordPress' => 1,
        'Ibnab_CloudZoomy' => 1,
        'JetRails_Cloudflare' => 1,
        'Kangaroorewards_Core' => 0,
        'Klarna_Core' => 1,
